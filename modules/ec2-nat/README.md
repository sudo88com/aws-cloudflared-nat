...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_ec2"></a> [aws\_ec2](#module\_aws\_ec2) | terraform-aws-modules/ec2-instance/aws | 5.6.1 |
...
| [aws_subnets.public_a](https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/data-sources/subnets) | data source |
| [aws_subnets.public_b](https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/data-sources/subnets) | data source |
| [aws_subnets.public_c](https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/data-sources/subnets) | data source |
| [aws_vpc.selected](https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/data-sources/vpc) | data source |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_CF_CLOUDFLARED_TOKEN"></a> [CF\_CLOUDFLARED\_TOKEN](#input\_CF\_CLOUDFLARED\_TOKEN) | Cloudflared registration token (Required) | `string` | `null` | no |
